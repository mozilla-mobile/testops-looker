# The name of this view in Looker is "Report Bugzilla Qe Needed Count Staging"
view: report_bugzilla_qe_needed_count_staging {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `moz-mobile-tools.staging.report_bugzilla_qe_needed_count_staging` ;;
  drill_fields: [id]
